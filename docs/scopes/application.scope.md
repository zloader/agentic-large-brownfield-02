...
- Only files matching these patterns are included: excalidraw-app/**/*.{ts,tsx,js}, packages/**/*.{ts,tsx,js}
...
## File: excalidraw-app/app-language/language-detector.ts
```typescript
...
## File: excalidraw-app/app-language/language-state.ts
```typescript
...
## File: excalidraw-app/app-language/LanguageList.tsx
```typescript
...
## File: excalidraw-app/collab/CollabError.tsx
```typescript
...
## File: excalidraw-app/components/AI.tsx
```typescript
import {
  DiagramToCodePlugin,
  exportToBlob,
...
## File: excalidraw-app/components/AppFooter.tsx
```typescript
...
## File: excalidraw-app/components/AppMainMenu.tsx
```typescript
import {
  loginIcon,
  ExcalLogo,
...
## File: excalidraw-app/components/AppSidebar.tsx
```typescript
...
## File: excalidraw-app/components/AppWelcomeScreen.tsx
```typescript
...
## File: excalidraw-app/components/DebugCanvas.tsx
```typescript
import {
  ArrowheadArrowIcon,
  CloseIcon,
...
export const saveDebugState = (debug:
⋮----
...
## File: excalidraw-app/components/EncryptedIcon.tsx
```typescript
import { Tooltip } from "@excalidraw/excalidraw/components/Tooltip";
...
## File: excalidraw-app/components/ExcalidrawPlusPromoBanner.tsx
```typescript

```

## File: excalidraw-app/components/ExportToExcalidrawPlus.tsx
```typescript
import React from "react";
...
## File: excalidraw-app/data/fileStatusStore.ts
```typescript
...
## File: excalidraw-app/data/firebase.ts
```typescript
...
## File: excalidraw-app/data/LocalData.ts
```typescript
...
## File: excalidraw-app/data/Locker.ts
```typescript
...
## File: excalidraw-app/data/tabSync.ts
```typescript
import { STORAGE_KEYS } from "../app_constants";
⋮----
...
## File: excalidraw-app/data/TTDStorage.ts
```typescript
...
## File: excalidraw-app/share/qrcode.chunk.ts
```typescript
import { renderSVG } from "uqr";
export const generateQRCodeSVG = (text: string): string =>
```

## File: excalidraw-app/share/QRCode.tsx
```typescript
...
## File: excalidraw-app/share/ShareDialog.tsx
```typescript
import { trackEvent } from "@excalidraw/excalidraw/analytics";
...
⋮----
trackEvent("share", "room creation", `ui ($
...
## File: excalidraw-app/tests/collab.test.tsx
```typescript
...
## File: excalidraw-app/tests/LanguageList.test.tsx
```typescript
...
## File: excalidraw-app/tests/MobileMenu.test.tsx
```typescript
import { UI } from "@excalidraw/excalidraw/tests/helpers/ui";
import {
...
## File: excalidraw-app/app_constants.ts
```typescript
...
## File: excalidraw-app/bug-issue-template.js
```javascript

```

## File: excalidraw-app/CustomStats.tsx
```typescript
...
## File: excalidraw-app/ExcalidrawPlusIframeExport.tsx
```typescript
...
## File: excalidraw-app/global.d.ts
```typescript
interface Window {
...
## File: excalidraw-app/useHandleAppTheme.ts
```typescript
...
## File: excalidraw-app/vite-env.d.ts
```typescript
